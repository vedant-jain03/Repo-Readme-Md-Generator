    ...
    return (
        <div className="inputsection section">
            ...
            <div className="input-field cont-guide">
                ...
                <input type="text" placeholder="Github UserName" value={github} onChange={e => setgithub(e.target.value)} style={{width:'20%',marginRight:'1rem'}} />
                <input type="text" placeholder="Github Repository Name" value={repo} onChange={e => setrepo(e.target.value)} style={{width:'20%'}} />
            </div>
        </div>
    )
}
